...
2 Temmuz 1970'te İskenderun Körfezi yakınlarında kaydedilen 8-10 birey yanlışlıkla Türkiye için ilk kayıt olarak bildirilmiştir (OST Bull. 7:1). 1881 yazında Antakya'da bir örnek alınmış @chantre1883 ve Ağustos 1871'de Büyük Ağrı Dağı yakınlarında muhtemelen şüpheli olarak gözlenmiştir @radde1884 . İlk güncel kayıt Nisan 1962'dedir @eggers1964@kumerloeve1966d ve 1970'lerin sonunda Akdeniz kıyılarında veya yakınlarında en az 11 güvenilir kayıt elde edilmiştir @kumerloeve1970a.
